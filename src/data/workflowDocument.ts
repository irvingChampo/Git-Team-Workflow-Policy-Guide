...
export const WORKFLOW_SECTIONS: WorkflowSection[] = [
  {
    id: "diagnostico",
    title: "1. Diagnóstico y Filosofía",
    badge: "Fundamentos",
    icon: "Activity",
    summary: "Por qué ocurren los problemas de merge desordenados y los 4 pilares para erradicarlos."
  },
  {
    id: "estrategia",
    title: "2. Estrategia y Nomenclatura",
    badge: "Convención",
    icon: "GitBranch",
    summary: "Estructura de ramas trunk-based con ramas efímeras y formato de nombres estándar."
  },
  {
    id: "ciclo-vida",
    title: "3. Ciclo de Vida Diario",
    badge: "Comandos",
    icon: "Clock",
    summary: "Paso a paso exacto desde que bajas cambios de main hasta que abres el Pull Request."
  },
  {
    id: "conflictos",
    ...
    badge: "Protocolo",
    icon: "ShieldAlert",
    summary: "Protocolo seguro con Git Rebase para solucionar conflictos sin perder código."
  },
  {
    id: "politicas",
    title: "5. Políticas del Repositorio",
    badge: "Seguridad",
    icon: "Lock",
    summary: "Branch Protection Rules para bloquear push directo y exigir revisiones."
  },
  {
    id: "cheat-sheet",
    title: "6. Cheat Sheet & Reglas",
    badge: "Referencia",
    icon: "FileText",
    summary: "Tabla rápida de comandos indispensables y las 5 Reglas de Oro del equipo."
  },
  {
    id: "caso-practico",
    title: "7. Caso Práctico Completo",
    badge: "Ejemplo Real",
    icon: "Terminal",
    summary: "Simulación de un caso real paso a paso con dos desarrolladores trabajando a la vez."
  }
];

export const RAW_MARKDOWN_CONTENT = `# 📘 Guía Oficial y Protocolo de Git para el Equipo
...
2. **No uses \`git merge main\` en tu rama local; usa \`git rebase origin/main\`**.
3. **Haz \`pull/fetch\` al inicio del día y antes de abrir un PR**.
4. **Comunica cambios estructurales en archivos globales (ej. rutas, dependencias, variables de entorno)**.
5. **Revisa los PRs de tus compañeros en menos de 24 horas para no bloquear el flujo**.
