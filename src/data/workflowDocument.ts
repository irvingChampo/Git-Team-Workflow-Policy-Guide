...
export const WORKFLOW_SECTIONS: WorkflowSection[] = [
  {
    ...
    badge: "Fundamentos",
    icon: "Activity",
    summary: "Por qué ocurren los problemas de merge desordenados y el rol de develop vs main."
  },
  {
    id: "estrategia",
    title: "2. Estrategia develop/main",
    badge: "Arquitectura",
    icon: "GitBranch",
    summary: "Ramas efímeras basadas en develop y main reservada exclusivamente para producción probada."
  },
  {
    id: "ciclo-vida",
    ...
    badge: "Comandos",
    icon: "Clock",
    summary: "Paso a paso exacto desde que bajas cambios de develop hasta que abres el Pull Request."
  },
  {
    id: "produccion",
    title: "4. Paso a Producción & Hotfixes",
    badge: "Releases",
    icon: "Rocket",
    summary: "Protocolo para pasar de develop a main y cómo atender hotfixes críticos de producción."
  },
  {
    id: "conflictos",
    ...
    badge: "Protocolo",
    icon: "ShieldAlert",
    summary: "Protocolo seguro con Git Rebase contra develop para solucionar conflictos sin perder código."
  },
  {
    id: "politicas",
    title: "6. Políticas del Repositorio",
    badge: "Seguridad",
    icon: "Lock",
    summary: "Branch Protection Rules para develop y main: prohibir push directo y exigir revisiones."
  },
  {
    id: "cheat-sheet",
    title: "7. Cheat Sheet & Reglas",
    badge: "Referencia",
    icon: "FileText",
  ...
  {
    id: "caso-practico",
    title: "8. Caso Práctico Completo",
    badge: "Ejemplo Real",
    icon: "Terminal",
    summary: "Simulación de un caso real paso a paso con dos desarrolladores trabajando en develop y pase a main."
  }
];
